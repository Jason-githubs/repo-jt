...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
    ...
    <thead>
        <tr>
            ...
            <!-- formatter作用:执行格式化的操作,将返回值结果进行展现;会传递2个参数,参数1:当前标签的value值;参数2:行号 -->
            <th data-options="field:'cid',width:100,align:'center',formatter:KindEditorUtil.findItemCatName">商品(叶子)类目</th>
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
                    ...
                    $.get("/item/cat/queryItemName",{"itemCatId":cid},function (name) {
                        //先找cid的input标签,之后找它的兄弟span,然后完成赋值操作
                        //$("input[name='cid']").prev().text(name);
